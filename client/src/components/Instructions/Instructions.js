        ...
        <div className='row'>
          <div className='col-md-6'>
            <div className='card step-card'>
              <div className="card-body">
                <h5 className="card-title card-instruction">1</h5>
          ...
          <div className='col-md-6'>
            <div className='card step-card'>
              <div className="card-body">
                  <h5 className="card-title card-instruction">2</h5>
        ...
        <div className='row'>
          <div className='col-md-6'>
            <div className='card step-card mt-4'>
              <div className="card-body">
                  <h5 className="card-title card-instruction">3</h5>
          ...
          <div className='col-md-6'>
            <div className='card step-card mt-4'>
              <div className="card-body">
                  <h5 className="card-title card-instruction">4</h5>
